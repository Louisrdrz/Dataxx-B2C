...
export default function DemoPage() {
  ...
  if (isSubmitted) {
    return (
      <>
        <Head>
          <title>Demande envoyée – Dataxx</title>
          <meta name="description" content="Votre demande de démo a été envoyée avec succès" />
        </Head>
        <div className="min-h-screen bg-gradient-to-b from-slate-50/50 to-white flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center px-4 sm:px-6">
            <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center max-w-md">
              ...
              <Link href="/" className="inline-flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white shadow-lg hover:shadow-xl transition-all duration-300 font-medium text-sm sm:text-base px-4 sm:px-6 py-2.5 sm:py-3 rounded-md">
                {t('demo.success.cta')}
              </Link>
            </motion.div>
          </div>
  ...
  return (
    <>
      <Head>
        <title>Demander une démo – Dataxx</title>
        <meta name="description" content="Réservez une démo personnalisée de Dataxx et découvrez comment transformer votre prospection sponsoring" />
      </Head>
      <div className="min-h-screen bg-gradient-to-b from-slate-50/50 to-white flex flex-col">
        <Header />
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-x-8 px-2">
                    {founders.map((f) => (
                      <div key={f.name} className="flex flex-col items-center group">
                        <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-full overflow-hidden border-4 border-white shadow-lg mb-3 sm:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 relative">
