    ...
    <header className="w-full px-6 py-4 bg-transparent sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between rounded-full px-6 py-3 bg-white/95 border border-gray-200">
        ...
        <div className="flex items-center space-x-4">
          <a href="/demo" className="bg-slate-900 hover:bg-slate-800 text-white px-6 sm:px-8 py-3 sm:py-4 text-base shadow-lg hover:shadow-xl transition-all duration-300 font-medium border-0 rounded-md inline-flex items-center justify-center">
            Demander une démo
          </a>
        </div>
      </div>
