      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50/50 to-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6">
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center max-w-md">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-3 sm:mb-4">Demande envoyée !</h2>
            <p className="text-sm sm:text-base text-slate-600 mb-6">
              Votre demande de démo a été envoyée avec succès. Nous vous recontacterons rapidement.
            </p>
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-[42%_58%] gap-6 sm:gap-10 items-start lg:items-stretch w-full max-w-7xl mx-auto">
            ...
            <div className="h-full flex flex-col justify-between gap-4 sm:gap-6">
              {/* Carte infos contact */}
              <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-slate-200/60 hover:shadow-md hover:border-slate-300/60 transition-all duration-300">
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6 tracking-tight">Informations de contact</h2>
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 text-slate-700 text-base sm:text-lg">
                  ...
                  <a href="mailto:contact@dataxx.fr" className="hover:text-slate-900 transition-colors duration-200 text-sm sm:text-base">contact@dataxx.fr</a>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 text-slate-700 text-base sm:text-lg">
                  <div className="bg-slate-100 p-2 sm:p-3 rounded-lg"><Phone className="w-5 h-5 sm:w-6 sm:h-6 text-slate-600" /></div>
                  <a href="tel:+33783339293" className="hover:text-slate-900 transition-colors duration-200 text-sm sm:text-base">+33 7 83 33 92 93</a>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 text-slate-700 text-base sm:text-lg">
                ...
                <div className="flex items-center gap-3 sm:gap-4 text-slate-700 text-base sm:text-lg">
                  ...
                  <a href="https://www.linkedin.com/company/dataxx-ai" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 transition-colors duration-200 text-sm sm:text-base">Dataxx</a>
                </div>
              </div>

              {/* Carte fondateurs */}
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200/60 hover:shadow-md hover:border-slate-300/60 transition-all duration-300">
            ...
            <div className="h-full relative rounded-2xl p-5 sm:p-8 flex flex-col justify-start shadow-2xl hover:shadow-3xl transition-all duration-300 overflow-hidden">
              {/* Fond identique au bandeau Partenariat (gradient violet profond) */}
              <div className="absolute inset-0 bg-[linear-gradient(135deg,hsl(261_65%_22%),hsl(270_55%_16%))]"></div>
              ...
              <div className="relative z-10">
                ...
                <form className="flex flex-col gap-3 sm:gap-4" onSubmit={handleSubmit}>
                  <div>
                    <label className="block text-white mb-2 font-semibold text-sm sm:text-base">Prénom</label>
                  ...
                  <div>
                    <label className="block text-white mb-2 font-semibold text-sm sm:text-base">Nom</label>
                  ...
                  <div>
                    <label className="block text-white mb-2 font-semibold text-sm sm:text-base">Entreprise</label>
                    <input name="company" value={formData.company} onChange={handleInputChange} required
                      className="w-full rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 bg-white/90 backdrop-blur-sm text-gray-800 border-none focus:outline-none focus:ring-2 focus:ring-slate-300 placeholder-gray-500 text-sm sm:text-base transition-all duration-200 hover:bg-white"
                      placeholder="Votre entreprise" />
                  </div>
                  <div>
                    <label className="block text-white mb-2 font-semibold text-sm sm:text-base">Téléphone</label>
                  ...
                  <button type="submit" disabled={isLoading}
                    ...
                    {isLoading ? (<span className="inline-flex items-center"><Loader2 className="w-5 h-5 mr-2 animate-spin" /> Envoi en cours...</span>) : "Réserver une démo"}
                  </button>
                </form>
              </div>
            </div>
