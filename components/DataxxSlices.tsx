...
// OLD: import clem from "@/assets/clem.jpeg";
const clem = "/clem.jpeg";
// OLD: import martin from "@/assets/martin.jpeg";
const martin = "/martin.jpeg";
// OLD: import louis from "@/assets/louis.jpeg";
const louis = "/louis.jpeg";
...
export default function DataxxSlices() {
  ...
  return (
    <>
      ...
      <section
        id="equipe"
        className="pt-8 sm:pt-12 pb-0 relative scroll-mt-28"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 tracking-tight">{t('founders.clement.name')}</h3>
              <p className="text-purple-600 font-semibold mb-4 text-base sm:text-lg">{t('founders.clement.role')}</p>
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 tracking-tight">{t('founders.martin.name')}</h3>
              <p className="text-blue-600 font-semibold mb-4 text-base sm:text-lg">{t('founders.martin.role')}</p>
              <div className="mt-auto">
                <a
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 tracking-tight">{t('founders.louis.name')}</h3>
              <p className="text-pink-600 font-semibold mb-4 text-base sm:text-lg">{t('founders.louis.role')}</p>
              <div className="mt-auto">
                <a
      ...
      <section className="pt-0 pb-0 overflow-hidden relative">
        <div className="relative py-12 sm:py-20">
          {/* Mobile faster */}
          <div
            className="flex items-center whitespace-nowrap animate-scroll-text sm:hidden"
          ...
          >
            {[...Array(8)].map((_, i) => (
              ...
              >
                <span className="text-slate-900">{t('founders.tagline').split(' ')[0]} {t('founders.tagline').split(' ')[1]}</span>
                <span className="mx-2"></span>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-700 to-slate-500">{t('founders.tagline').split(' ')[2]}</span>
                <span className="ml-4 sm:ml-8 text-transparent bg-clip-text bg-gradient-to-r from-slate-600 to-slate-800">
                  {t('founders.tagline').split(' ')[3]} {t('founders.tagline').split(' ')[4]} {t('founders.tagline').split(' ')[5]}
                </span>
              </span>
            ))}
          </div>

          {/* Desktop/tablet original speed */}
          <div
            className="hidden sm:flex items-center whitespace-nowrap animate-scroll-text"
  ...
  <section className="pt-0 pb-16 overflow-hidden relative">
    <div className="relative py-8 sm:py-12">
      {(() => {
        // Liste statique des logos partenaires
        const items = [
          "/HEC_Paris.svg.png",
          "/CloudforStartups.webp",
          "/logo-french-tech.png",
          "/Logo_Stade_Rennais_FC.svg.png",
        ...
        return (
          ...
          {/* Mobile faster */}
          <div
            className="flex sm:hidden items-center whitespace-nowrap animate-scroll-logos-reverse"
            style={{ animation: "scroll-logos-reverse 14s linear infinite" }}
          >
          ...
          {/* Desktop/tablet original speed */}
          <div
            className="hidden sm:flex items-center whitespace-nowrap animate-scroll-logos-reverse"
          ...
          >
            {renderItems.map((src, i) => (
              src ? (
                ...
                <span key={`gap-d-${i}`} className="inline-block w-[100vw]" />
              )
            ))}
          </div>
          </>
